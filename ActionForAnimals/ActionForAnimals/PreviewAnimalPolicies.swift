...
extension AnimalPolicy {
    ...
    **IF LEAVING VOICEMAIL:** Please leave your full street address to ensure your call is tallied.
    ...
    static let basicPreviewIssue = AnimalPolicy(id: 813, meta: "", name: "Support the Act", slug: "support-act-slug", reason: AnimalPolicy.issueReason, script: AnimalPolicy.issueScript, categories: [Category(name: "Budget")], active: true, outcomeModels: [Outcome(label: "Contacted", status: "contact"), Outcome(label: "Voicemail", status: "voicemail")], contactType: "reps", contactAreas: ["US House", "US Senate"], createdAt: Date(timeIntervalSince1970: 1688015904), status: "active", stats: Stats(calls: 0))
    static let multilinePreviewIssue = AnimalPolicy(id: 812, meta: "", name: "Support the Act whose name is quite long", slug: "support-act-slug2", reason: AnimalPolicy.issueReason, script: AnimalPolicy.issueScript, categories: [Category(name: "Environment")], active: true, outcomeModels: [Outcome(label: "Contacted", status: "contact"), Outcome(label: "Voicemail", status: "voicemail")], contactType: "reps", contactAreas: ["US House", "US Senate"], createdAt: Date(timeIntervalSince1970: 1688015904), status: "active", stats: Stats(calls: 0))
    static let extraLongPreviewIssue = AnimalPolicy(id: 811, meta: "", name: "Call for supportive action in a made up region with extra long details", slug: "support-act-slug2", reason: AnimalPolicy.issueReason, script: AnimalPolicy.issueScript, categories: [Category(name: "Environment")], active: true, outcomeModels: [Outcome(label: "Contacted", status: "contact"), Outcome(label: "Voicemail", status: "voicemail")], contactType: "reps", contactAreas: ["US House", "US Senate"], createdAt: Date(timeIntervalSince1970: 1688015904), status: "active", stats: Stats(calls: 0))
    static let houseOnlyPreviewIssue = AnimalPolicy(id: 813, meta: "", name: "Support the Act", slug: "support-act-slug", reason: AnimalPolicy.issueReason, script: AnimalPolicy.issueScript, categories: [Category(name: "Budget")], active: true, outcomeModels: [Outcome(label: "Contacted", status: "contact"), Outcome(label: "Voicemail", status: "voicemail")], contactType: "reps", contactAreas: ["US House"], createdAt: Date(timeIntervalSince1970: 1688015904), status: "active", stats: Stats(calls: 0))
